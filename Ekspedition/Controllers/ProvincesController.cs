...
namespace Ekspedition.Controllers
{
    public class ProvincesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name")] Province province)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name")] Province province)
        {
            if (ModelState.IsValid)
            {
